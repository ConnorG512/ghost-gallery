...
Enemy::Enemy(const std::array<int, 2> xy_pos, const int base_damage,
             const int critical_chance, const int given_score,
    ...
    : Entity{{"assets/image/entity/enemy/ghost/ghost-1.png"},
             ...
             xy_pos.at(0),
             xy_pos.at(1)},
      damage_component{base_damage, critical_chance},
...
{
    setNewEntityPosition({RandomGeneration::GenerateRandomNumber(100, 1400),
                          RandomGeneration::GenerateRandomNumber(200, 750)});
...
{
    score_to_give = RandomGeneration::GenerateRandomNumber(score_range.at(0),
                                                           score_range.at(1));
}
