...
GameManager::GameManager()
  ...
  , m_current_gamestate { std::make_unique<GameStateSplash>( this, m_game_window, m_score_manager )} {}
...
void GameManager::changeCurrentGameState( GameType gamestate ) 
{
  switch ( gamestate ) 
  {
    ...
    case GameType::gameplay:
      m_current_gamestate = std::make_unique<GameStateGameplay>( this, m_game_window, m_score_manager );
      break;
  }
}
